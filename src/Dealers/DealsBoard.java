...
public class DealsBoard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 10, 110, 60));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 160, 850, 550));
        ...
        Uaname1.setText("CREATE");
        add.add(Uaname1);
        Uaname1.setBounds(60, 20, 130, 20);

        jPanel1.add(add, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 400, 250, 60));
        ...
        jLabel7.setText("CARS INFO");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 100, 400, 60));

        jLabel8.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(191, 174, 112));
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel8.setText("DEALER DASHBOARD");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 80, 270, 40));
    ...
    private void addMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addMouseClicked
       int rowIndex = usertab.getSelectedRow();
        ...
        if(rs.next()){
            String status = rs.getString("c_status");  // assuming the status column is named c_status
            if("unavailable".equalsIgnoreCase(status)){
                JOptionPane.showMessageDialog(null, "Selected item unavailable");
            } else {
                DealsAdd ad = new DealsAdd();                    
                ad.cid.setText(""+rs.getString("c_id"));
                ad.cn.setText(""+rs.getString("c_name"));               
                ad.cs.setText(""+rs.getString("c_serial"));
                ad.cp.setText(""+rs.getString("c_price"));
                ad.image.setIcon(ad.ResizeImage(rs.getString("c_image"),null, ad.image));
                ad.oldpath = rs.getString("c_image");
                ad.path = rs.getString("c_image");
                ad.destination = rs.getString("c_image");
                ad.setVisible(true);
                this.dispose();
                 }
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DealsBoard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DealsBoard().setVisible(true);
            }
        });
    }
